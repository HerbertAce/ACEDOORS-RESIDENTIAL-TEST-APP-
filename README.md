# AceDoors Residential v0.4.7

Flat GitHub Pages review release for testing multiple residential clients, quotes and site addresses in the same browser, while retaining the v0.4.6 workflow and commercial safeguards.
...
- Existing v0.4.6 browser drafts migrate automatically into the v0.4.7 job list.
